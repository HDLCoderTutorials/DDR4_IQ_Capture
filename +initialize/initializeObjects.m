...
radarSetupCellArray = {...
    ...
    'prf_hz',10e3,...
    'scene_start_m',(5e-6 + 1/output.synthesisConfig.fpga_clock_rate_hz)* pl_config.RadarSetup.c/2 ,... % pulse width plus 1 cycle to match original
    'range_swath_m', (5e-6)*4 * pl_config.RadarSetup.c ,...
